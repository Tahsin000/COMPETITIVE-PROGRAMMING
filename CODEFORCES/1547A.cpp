...
void solve()
{
    ...
    if (a1 == b1 || a2 == b2)
    {
        if (a1 == b1 && a1 == f1)
        {
            if(llabs(b2 - a2) == llabs(a2 - f2) + llabs(b2 - f2))
                cout << llabs(b2 - a2) + 2 << endl;
            else 
                cout << llabs(b2 - a2) << endl;
        }
        else if (a2 == b2 && a2 == f2)
        {
            if(llabs(b1 - a1) == llabs(a1 - f1) + llabs(b1 - f1))
                cout << llabs(b1 - a1) + 2 << endl;
            else 
                cout << llabs(b1 - a1) << endl;

        }
        else 
            cout << llabs(b1 - a1) + llabs(a2 - b2) << endl;
    } 
    else 
    {
        cout << llabs(b1 - a1) + llabs(a2 - b2) << endl;
