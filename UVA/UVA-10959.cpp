...
void solve()
{
    ...
    /*
        START TIMR : " Tue Nov 16 23:06:28 2021 "
        END TIMR : " Tue Nov 16 23:29:57 2021 "
        PROBLEM : https://onlinejudge.org/external/109/10959.pdf
    */
    ll tt; cin >> tt;
    string s = "";
    while(tt--){
        ...
        std::vector<ll> level(1000, -1);
        std::vector<ll> adj[20000];
        for(ll i=0; i<edge; i++){
            ll u, v; cin >> u >> v;
            adj[u].pb(v);
            adj[v].pb(u);
