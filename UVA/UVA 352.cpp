...
/*
    PROBLEM START : Wed Nov 17 08:09:43 2021
    PROBLEM END : Wed Nov 17 08:31:16 2021
    PROBLEM LINK : https://onlinejudge.org/index.php?option=onlinejudge&Itemid=8&page=show_problem&problem=288
*/
ll n; 
string s[120];
ll trk[120][120]; 
...
void solve()
{
    ...
    while(cin >> n && n){
        ...
        cout << "Image number " << ++p << " contains " << cnt << " war eagles.\n";
    }
}
int main()
{
