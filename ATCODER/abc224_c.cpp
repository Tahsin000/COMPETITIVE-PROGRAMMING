...
bool slope(pair<ll, ll>a, pair<ll, ll>b, pair<ll, ll>c){
    ll x1 = a.ff, x2 = b.ff, y1 = a.ss, y2 = b.ss, x3 = c.ff, y3 = c.ss;
    ll ans1 = (y3 - y2)*(x2 - x1);
    ll ans2 = (y2 - y1)*(x3 - x2);
    return ans1 != ans2;
...
void solve()
{
    // Tue Oct 26 23:35:23 2021
    // END TIME : Tue Oct 26 23:52:07 2021
    ll n; cin >> n;
    vector<pair<ll, ll>>v;
    for(ll i=0; i<n; i++) {
        ll x, y; cin >> x >> y;
