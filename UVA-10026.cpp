...
struct job
{
    ll dis;ll index;ll a;ll b;
}; 

bool com(const job &a , const job &b){
    double pos1 = a.b/ (double)a.a;
    double pos2 = b.b/ (double)b.a;
    if (pos2 != pos1) return pos1 > pos2;
    // if (a.dis == b.dis) return a.a < b.b;
